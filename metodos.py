...
#ELIGE UNA RUTA
    ...
    def click_order_a_taxi_button(self):
        WebDriverWait(self.driver, 40).until(expected_conditions.visibility_of_element_located(self.locators.order_a_taxi_button))
        self.driver.find_element(*self.locators.order_a_taxi_button).click()

    def click_fare_comfort(self):
        WebDriverWait(self.driver, 40).until(expected_conditions.visibility_of_element_located(self.locators.fare_comfort))
    ...
    def click_button_phone_number(self):
        WebDriverWait(self.driver, 40).until(expected_conditions.element_to_be_clickable(self.locators.button_phone_number))
        self.driver.find_element(*self.locators.button_phone_number).click()


    def set_field_number(self):
        WebDriverWait(self.driver, 40).until(expected_conditions.visibility_of_element_located(self.locators.field_number))
    ...
    def click_field_pay(self):
        WebDriverWait(self.driver, 40).until(expected_conditions.presence_of_element_located(self.locators.field_pay))
    ...
    def click_cvv_field_code(self):
        WebDriverWait(self.driver, 40).until(expected_conditions.presence_of_element_located(self.locators.cvv_field_code))
    ...
    def click_text_add_card(self):
        WebDriverWait(self.driver, 40).until(expected_conditions.element_to_be_clickable(self.locators.cvv_field_code))
    ...
    def click_close_button(self):
        WebDriverWait(self.driver, 40).until(expected_conditions.presence_of_element_located(self.locators.close_button))
    ...
    def click_field_message_driver(self):
        WebDriverWait(self.driver, 40).until(expected_conditions.element_to_be_clickable(self.locators.field_message_driver))
        self.driver.find_element(*self.locators.field_message_driver).click()

    def set_field_message_driver(self):
        WebDriverWait(self.driver, 40).until(expected_conditions.visibility_of_element_located(self.locators.field_message_driver))
    ...
    def click_accessory_button(self):
        WebDriverWait(self.driver, 40).until(expected_conditions.visibility_of_element_located(self.locators.accessory_button))
    ...
    def click_plus_ice_button(self):
        WebDriverWait(self.driver, 40).until(expected_conditions.visibility_of_element_located(self.locators.plus_ice_button))
    ...
    def click_end_order_a_taxi(self):
        WebDriverWait(self.driver, 40).until(expected_conditions.visibility_of_element_located(self.locators.end_order_a_taxi))
    ...
    #CAMBIO DE TIEMPO DE ESPERA DE 20 A 40, CORRECCION
